...
class NeetHomeScreen extends ConsumerStatefulWidget {
  const NeetHomeScreen({super.key});

  @override
  ConsumerState<NeetHomeScreen> createState() => _NeetHomeScreenState();
}
...
class _NeetHomeScreenState extends ConsumerState<NeetHomeScreen> {
  ...
  /// Maps chip index → subject ID filter.  Null = show all, -1 = navigate away.
  String? _chipSubjectFilter(int index) {
    switch (index) {
      case 0: return null;       // All
      case 1: return 'biology';  // Botany
      case 2: return 'biology';  // Zoology
      case 3: return 'phys';     // Physics
      case 4: return 'chem';     // Chemistry
      case 5: return null;       // Error Book (handled via navigate)
      default: return null;
    }
  }
