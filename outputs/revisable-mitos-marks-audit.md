...
**Scope:** Revisable, Mitos Learning, MARKS by MathonGo vs. `neet_mitos` Flutter codebase  
...
**Bottom line:** `neet_mitos` is a well-architected skeleton with a feature-rich UI but a thin core. To compete, it must prioritize question volume, retention mechanics, and exam simulation before adding more screens.
...
**Positioning:** "#1 self study platform for medical exams" targeting NEET UG, NEET PG, INICET, FMGE, AMC, USMLE, PLAB, and others. Claims 100K+ medical students and 10,000+ rankers in the last 12 months.

**Content Scale:** 200K+ flashcards, 100K+ MCQs, 5K+ educator-created notes & videos.

**Key Features:**
- **Ruby AI — 24×7 AI Tutor:** Context-aware answers grounded in trusted medical content, plus AI-powered test analysis that tracks weak subjects, silly mistakes, retention gaps, and revision patterns.
- **Smart Flashcards with Spaced Repetition:** Adaptive scheduling that personalizes to the user's memory curve.
- **AI-Generated Content:** Instantly generates flashcards, summaries, rapid revision notes, and custom quizzes from weak areas.
- **Personalized Test Prep:** AI automatically creates targeted test modules based on weak areas.

**Retention Mechanics:** Bite-sized learning tracks weak topics, mistakes, confidence, and revision patterns. Smart revision schedules content at optimal intervals.

**Monetization:** Free tier includes flashcards, QBanks, mock tests, notes, videos, and basic AI tools with rate-limiting and no cloud sync. Pro tiers (₹999 quarterly, ₹1,999 annual) unlock unlimited AI, personalized revision modules, and multi-device sync.

**Technical Note:** Cloud sync and personalized revision are paywalled — a deliberate freemium lever.

---

### 1.2 Mitos Learning (com.mitoslearning)

**Positioning:** Mitos Learning Exam Prep launched this app in December 2025. Claim: "90/90 questions match in NEET 2026 Biology."

**Content Scale:** 40,000+ NCERT core concept questions, 35 Rank Booster test series, 30+ years of PYQs, HD comprehensive study notes.
...
**Critical Caveat — Name Confusion with MemoNeet:** Web searches for "Mitos Learning NEET" frequently surface **MemoNeet** (com.adithya.memoneet), a separate, much larger app. MemoNeet claims 35,000+ NCERT MCQs, 1.5M+ aspirants, 97% NEET 2026 match, Brahmastra Test Series, and the "NeuronZ" AI-based revision system. If the intended competitor was the major "line-by-line NCERT" player, **MemoNeet** is the correct benchmark, not Mitos Learning.

---

### 1.3 MARKS by MathonGo (com.scoremarks.marks)

**Positioning:** "The IIT JEE & NEET Prep App" by Scoremarks Technologies Pvt Ltd. 1,000,000+ downloads, 2,000,000+ questions solved daily, 40,000+ reviews.

**Content Scale:** Chapter-wise PYQs for NEET, JEE Main, JEE Advanced, BITSAT, WBJEE, MHT CET, NDA, KVPY, plus NTA Abhyas questions. No explicit total MCQ count, but daily solve volume implies massive catalog.

**Key Features:**
- **Chapter-wise Previous Year Questions:** Downloadable, organized by chapter and exam.
- **Unlimited Custom Tests:** Create as many custom tests as desired for free.
- **Quiz Mode:** Timed practice with instant feedback.
- **Formula Cards:** Quick-reference formula sheets.
- **Daily Practice Challenge:** Goal completion mechanics.

**UX/Design:** Clean, minimal UI with light/dark mode. Low-friction entry; no login required for basic practice.
...
1. **Question Bank <1% of Competition**
   - Darwin fields 33K–38K+ MCQs. MemoNeet 35K+. Mitos Learning 40K+. Our codebase contains ~26 seeded sample questions; total remains well under 500.
   - **Impact:** Users cannot practice enough to build exam stamina or coverage.

2. **No Spaced Repetition / Retention Engine**
   - Revisable's "smart revision" and MemoNeet's "NeuronZ" are core value props. Industry consensus: spaced repetition improves long-term retention by up to 200% vs. cramming.
   - **Impact:** Students forget what they study; retention is the #1 predictor of NEET rank.

3. **No CBT-Ready Mock Simulator**
   - NEET UG is shifting to CBT from 2027 due to the 2026 paper-leak controversy. Apps without CBT simulation will be at a structural disadvantage.
...
4. **AI Chatbot Not NCERT-Grounded**
   - Revisable's Ruby AI is "grounded in trusted medical content." Our Gemini chat is a generic wrapper with no RAG over NCERT or question bank.
...
5. **No Streaks, Leaderboards, or Gamification**
   - MedicNEET uses daily streaks + leaderboards. Yukthis uses XP, streaks, achievements, live rankings. Edvaya uses streaks and leaderboards. Education app Day 30 retention is 2–3% without engagement mechanics.
   - **Impact:** Low Day 30 retention kills organic growth.

6. **Rank Predictor is Static Hardcoded Table**
   - Our `rank_predictor.dart` contains hardcoded 2023–2024 data. Revisable and Mitos Learning both claim "high-accuracy NEET score prediction" with trend analysis.
   - **Impact:** Students cannot trust predictions; feature feels broken after one exam cycle.

7. **Cloud Sync Incomplete**
   - Our `cloud_sync_service.dart` has pull logic with an empty loop body. Revisable paywalls sync as a premium feature.
   - **Impact:** Multi-device users lose progress; backup/reinstall is data-destructive.

8. **No Batch Segmentation**
   - No Class 11 / Class 12 / Dropper onboarding. Competitors tailor content and study plans to batch.
   - **Impact:** Generic experience fails to account for different syllabus coverage and exam timelines.

### Minor Gaps (Polish)

9. **Duplicate Provider Files** — `lib/core/provider/providers.dart` and `lib/core/providers/providers.dart` conflict.

10. **Bundled NCERT PDFs Unused** — `assets/ncert_books/` contains mapped PDFs, but `pdf_picker_screen.dart` uses `file_picker` for user-selected files rather than bundled assets.

11. **ML Service is Dummy Code** — `ml_service.dart` uses character-code based "tokenization" with no real model or embeddings.

12. **No Formula Cards / Quick Revision Notes** — MARKS offers formula cards; Revisable offers "rapid revision notes." We have neither.
...
- **Supabase:** Free Tier for first 500 MAU; Pro (~$25/month) for scaling.
